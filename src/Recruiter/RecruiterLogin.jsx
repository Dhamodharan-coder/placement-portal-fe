...
const RecruiterLogin = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                const response = await axios.post('https://dhru-placement-portal.onrender.com/recruiter/recruiter-login', values);
            ...
            <div className="bg-gray-100 flex items-center justify-center h-screen">
                <div className="bg-white rounded-lg shadow-lg p-8 max-w-sm w-full">
                    ...
                    <p className="text-gray-600 text-center mt-4">
                        Don't have an account? <Link to="/recruiter-register" className="text-indigo-800 hover:underline">Sign Up</Link>
                    </p>
                </div>
            </div>
            <Footer />
